...
function enrichOffers(rawOffers) {
  const result = (rawOffers || []).map((o) => ({
    ...
    // KASKO-specific conditions actually granted by this company for this
    // offer — undefined/null for OSAGO/mortgage offers.
    compensationType: o.compensationType ?? null,
    coverageProgram: o.coverageProgram ?? null,
    deductibleType: o.deductibleType ?? null,
    deductibleAmount: o.deductibleAmount ?? null,
    insuranceSum: o.insuranceSum ?? null,
    description: o.description ?? null,
    agentCommission: o.agentCommission ?? null,
    agentCommissionPercentage: o.agentCommissionPercentage ?? null,
